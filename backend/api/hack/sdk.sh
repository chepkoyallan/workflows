...
# rm -r -f backend/api/_http_client/*
rm -f -f backend/api/sdk/*
...
cp ${TMP_OUTPUT}/github.com/chepkoyallan/workflows/backend/api/sdk/* ./backend/api/sdk
